...
1. Accept one to 50 JPEG, PNG, GIF, or WebP images directly. Accept HEIC/HEIF in the web client by converting it locally to JPEG before upload. Keep the server allowlist and signature validation limited to Azure-supported formats, with a maximum of 5 MB per uploaded image after conversion.
